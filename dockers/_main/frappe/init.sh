...
# ============================================================
# Reset old Frappe data when a NEW image was built
# ============================================================

if [ "$NEW_IMAGE_BUILT" -eq 1 ] && [ "${RESET_DATA_ON_NEW_IMAGE:-0}" = "1" ]; then

    echo
    echo "============================================================"
    echo "NEW IMAGE + RESET ENABLED"
    echo "============================================================"
    echo
    echo "WARNING: Existing Frappe sites and database will be deleted."
    echo
    ...
    echo "→ Old Frappe data removed."

else

    echo
    echo "→ Keeping existing Frappe data."
